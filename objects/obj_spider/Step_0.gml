...
if(fadeDone)
{
	...
	global.enemyBattleObject = obj_battleSpider;
	global.enemyObject = obj_spider;
	global.enemyArmor = 0;
	global.enemyDamage = 5;
	global.battleDifficulty = global.overallDifficulty + 2;
    room_goto(rm_caveBattle);
}
if(distance_to_object(obj_player) < 100)
{
	sprite_index = spr_spiderMoving;	
	move_towards_point(obj_player.x, obj_player.y, spd);
}
else
{
	sprite_index = spr_spiderStill;	
	speed = 0;
}
